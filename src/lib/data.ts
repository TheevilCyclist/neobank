...
export const BANKS: Bank[] = [
  ...
  {
    id: "bunq", url: "https://www.financeads.net/tc.php?t=84762C3156123233T", name: "bunq", mono: "b", typ: "Neobank", tarif: "bunq Free", fee: 0, feeNote: "dauerhaft kostenlos",
    ...
    intro: "bunq ist die einzige Bank im Radar, die das Konto als Datei-System denkt: bis zu 25 Unterkonten mit eigener IBAN. Im bunq-Free-Tarif ist das dauerhaft kostenlos und für drei Gruppen besonders wertvoll: WGs, Paare mit Drei-Konten-Modell und Selbstständige mit Steuer-Pocket.",
    ...
    daten: [["Kontoführung", "0 € / Monat (bunq Free)"], ["Guthabenzins", "bis 2,01 % p. a. (variabel)"], ["Unterkonten", "bis 25 mit eigener IBAN"], ["Karte", "Maestro/Mastercard, Apple/Google Pay"], ["Lizenz", "Niederländische Banklizenz & Einlagensicherung"]],
    ...
    fazit: "Für strukturierte Köpfe und Selbstständige im Free-Tarif ein echter Gewinn, für alle anderen Overkill.",
    stackRole: "Struktur-Konto im Selbstständigen-Stack.",
    alternativen: ["n26", "c24"],
    faq: [["Kostet bunq Geld?", "Der bunq-Free-Tarif ist dauerhaft kostenlos; nur höhere Tarife mit Zusatzleistungen kosten extra."], ["Ist mein Geld sicher?", "bunq unterliegt der niederländischen Einlagensicherung bis 100.000 €."], ["Eignet sich bunq fürs Gemeinschaftskonto?", "Ja, über geteilte Unterkonten, siehe Gemeinschaftskonto-Ratgeber."]],
  },
  {
